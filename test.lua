...
ShiftLockToggleFrame.Position = UDim2.new(1, -60, 0.5, -12)
ShiftLockToggleFrame.BackgroundColor3 = Color3.fromRGB(50, 50, 60)
ShiftLockToggleFrame.Parent = ShiftLockContainer
...
-- Функции для обновления позиции и поворота
