...
-- Anti-AFK функционал (первый элемент в ScriptsFrame)
...
-- Добавляем в ScriptsFrame после других функций
...
FlyContainer.Name = "Fly"
FlyContainer.Size = UDim2.new(1, -20, 0, 90)  -- Большая высота для полета
...
FlyToggleFrame.Position = UDim2.new(1, -60, 0, 7)
...
FlyBoxCorner.CornerRadius = UDim.new(0, 4)
...
FlySpeedBox.FocusLost:Connect(function(enterPressed)
    ...
    if speed then
        flySpeed = math.clamp(speed, 1, 100)
